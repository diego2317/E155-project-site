...
![MCU Routine](/images/mcu_fsm.png)
...
In order to gain experience with an available **SOMETHING** the HAL was used. Use of the HAL enables a much simpler initialization of the STM32L432KC's peripherals than using CMSIS templates, as it eliminates the need to write our own drivers, instead enabling the use of vendor-provided peripheral drivers. The peripherals used by the team, as well as their usage, are briefly described below.
